...
const Sidenav = () => {
    const [nav, setNav] = useState(false); // Perbaikan di sini
    ...
    return (
        <div>
            ...
            {
                nav ? (
                    <div className='fixed w-full h-screen bg-gray-500 bg-opacity-50  flex flex-col justify-center items-center z-20'> 
